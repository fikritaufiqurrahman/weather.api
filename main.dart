...
class _ApiWeatherState extends State<ApiWeather> {
  List<String> list = <String>['Kuningan', 'Bandung', 'Jakarta', 'Semarang'];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('get API Weather')),
      body: SafeArea(
          child: isLoading
              ? Center(
                  child: Column(
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        children: [
                          ...
                          DropdownButton<String>(
                            ...
                            style: const TextStyle(
                                color: Colors
                                    .deepPurple), //underline: Container(height: 2, color: Colors.deepPurpleAccent,),
                      ...
                      if (!isLoading) ...[
                        Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              Text(
                                'Deskripsi : ${weatherResponseModel.description}',
                                style: const TextStyle(
                                    color: Colors.white,
                                    fontSize: 12,
                                    fontWeight: FontWeight.normal),
                              ),
                              Text('Suhu : ${weatherResponseModel.temperature}',
                                  style: const TextStyle(
                                      color: Colors.white,
                                      fontSize: 12,
                                      fontWeight: FontWeight.normal)),
                              Text(
                                  'Kecepatan Angin : ${weatherResponseModel.wind}',
                                  style: const TextStyle(
                                      color: Colors.white,
                                      fontSize: 12,
                                      fontWeight: FontWeight.normal)),
                        ...
                        const SizedBox(height: 10),
                        const Text('Perkiraan Cuaca selama 3 Hari : ',
                            style: TextStyle(
                                color: Colors.black,
                                fontSize: 14,
                                fontWeight: FontWeight.bold)),
                              ...
                              return Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                        'Hari ke : ${weatherResponseModel.forecast![index].day}',
                                        style: const TextStyle(
                                            color: Colors.black,
                                            fontSize: 12,
                                            fontWeight: FontWeight.normal)),
                                    Text(
                                        'Angin : ${weatherResponseModel.forecast![index].wind}',
                                        style: const TextStyle(
                                            color: Colors.black,
                                            fontSize: 12,
                                            fontWeight: FontWeight.normal)),
                                    Text(
                                        'Suhu : ${weatherResponseModel.forecast![index].temperature}',
                                        style: const TextStyle(
                                            color: Colors.black,
                                            fontSize: 12,
                                            fontWeight: FontWeight.normal)),
